...
function SortTh({
  ...
  return (
    ...
    >
      {label}
      {active && <span style={{ marginLeft: 4, opacity: 0.6 }}>{dir === 'asc' ? '↑' : '↓'}</span>}
    </th>
  )
}
  ...
  return (
    <div>
                  ...
                  <div style={{ display: 'flex', gap: 3, flexShrink: 0 }}>
                    <span
                      style={{
                        ...
                        background:
                          a.cap_pct >= 1
                            ? 'color-mix(in oklch, var(--color-positive) 18%, transparent)'
                            : 'color-mix(in oklch, var(--fg) 6%, transparent)',
                        color: a.cap_pct >= 1 ? 'var(--color-positive)' : 'var(--fg-faint)',
                      }}
                    >
                      CAP
                    </span>
                      ...
                      style={{
                        ...
                        background:
                          a.rec_pct >= 1
                            ? 'color-mix(in oklch, var(--color-positive) 18%, transparent)'
                            : 'color-mix(in oklch, var(--fg) 6%, transparent)',
                        color: a.rec_pct >= 1 ? 'var(--color-positive)' : 'var(--fg-faint)',
                      }}
                    >
                      REC
                    </span>
                      ...
                      style={{
                        ...
                        background:
                          a.mds_pct >= 1
                            ? 'color-mix(in oklch, var(--color-positive) 18%, transparent)'
                            : 'color-mix(in oklch, var(--fg) 6%, transparent)',
                        color: a.mds_pct >= 1 ? 'var(--color-positive)' : 'var(--fg-faint)',
                      }}
                    >
                      MDS
                    </span>
      ...
      >
                ...
                return (
                  <tr
                    ...
                    style={{
                      background:
                        i % 2 === 1
                          ? 'color-mix(in oklch, var(--fg) 2%, transparent)'
                          : 'transparent',
                    }}
                    onMouseEnter={(e) => {
        ...
        >
          {total} assessores · Pleno: cap R$700K / rec R$40K · Senior: cap R$1,4M / rec R$60K · MDS
          trigger: 65 pts
        </div>
      </div>
    </div>
