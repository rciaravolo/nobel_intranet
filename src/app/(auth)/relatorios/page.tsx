...
const REPORTS = [
  {
    id: 'r1',
    type: 'Performance',
    title: 'XPerformance — Fevereiro 2026',
    period: 'Fev 2026',
    pages: 24,
    size: '2,4 MB',
    date: '14 Mar 2026',
  ...
  },
  {
    id: 'r2',
    type: 'Captação',
    title: 'Captação Líquida — Fevereiro 2026',
    period: 'Fev 2026',
    pages: 12,
    size: '1,1 MB',
    date: '10 Mar 2026',
  ...
  },
  {
    id: 'r3',
    type: 'Gerencial',
    title: 'Relatório Gerencial — Q1 2026',
    period: 'Q1 2026',
    pages: 48,
    size: '5,7 MB',
    date: '05 Mar 2026',
  ...
  },
  {
    id: 'r4',
    type: 'Compliance',
    title: 'Compliance & Risco — Mar 2026',
    period: 'Mar 2026',
    pages: 18,
    size: '1,8 MB',
    date: '01 Mar 2026',
  ...
  },
  {
    id: 'r5',
    type: 'Performance',
    title: 'XPerformance — Janeiro 2026',
    period: 'Jan 2026',
    pages: 24,
    size: '2,3 MB',
    date: '14 Fev 2026',
  ...
  },
  {
    id: 'r6',
    type: 'Captação',
    title: 'Captação Líquida — Janeiro 2026',
    period: 'Jan 2026',
    pages: 11,
    size: '0,9 MB',
    date: '10 Fev 2026',
  ...
  },
  {
    id: 'r7',
    type: 'Gerencial',
    title: 'Relatório Gerencial — Q4 2025',
    period: 'Q4 2025',
    pages: 52,
    size: '6,1 MB',
    date: '05 Jan 2026',
  ...
  },
  {
    id: 'r8',
    type: 'Compliance',
    title: 'Compliance & Risco — Dez 2025',
    period: 'Dez 2025',
    pages: 16,
    size: '1,6 MB',
    date: '15 Jan 2026',
...
export default function RelatoriosPage() {
  ...
  const filtered = activeType === 'Todos' ? REPORTS : REPORTS.filter((r) => r.type === activeType)
      ...
      >
        <div>
          <p style={{ fontSize: 12, color: 'rgba(26,18,9,0.4)', marginBottom: 4 }}>
            {novos > 0
              ? `${novos} novo${novos > 1 ? 's' : ''} disponíve${novos > 1 ? 'is' : 'l'}`
              : 'Sem novidades'}
          </p>
          <h1
            style={{
            ...
            return (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  borderBottom:
                    i < filtered.length - 1 ? '1px solid rgba(184,150,62,0.08)' : 'none',
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = r.status === 'novo' ? '#fffef9' : '#fff'
                }}
              >
