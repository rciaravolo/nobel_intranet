...
function sinal(pctMeta: number | null, meta: number): Sinal {
  ...
  if (pctMeta >= 0.80) return 'amarelo'
  return 'vermelho'
}
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ height: 5, background: 'var(--n-100)', borderRadius: 3, overflow: 'hidden', marginTop: 8 }}>
            <div style={{
              ...
              background: SINAL_COR[sinalTotalC], borderRadius: 3, opacity: 0.85,
            }} />
          </div>
        </div>
        ...
        <div style={{ padding: '6px 0' }}>
          {produtos.filter(p => p.meta > 0).map((p, i, arr) => {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginTop: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 10, color: SINAL_COR[sinalTotal], marginTop: 4, fontWeight: 600 }}>
            ...
            {produtos.map((p, i) => {
              ...
              return (
                <tr key={p.slug}>
                  ...
                  {/* Realizado */}
                  <td style={{ ...td, borderBottom: isLast ? 'none' : td.borderBottom, fontWeight: 600 }}>
                    {fBRL(p.realizado)}
                  </td>
                  {/* Meta */}
                  ...
                  {/* % Atingido */}
                  <td style={{ ...td, borderBottom: isLast ? 'none' : td.borderBottom, fontWeight: 600, color: cor }}>
                    {fPct(p.pctAtingido)}
                  </td>
                  {/* Gap */}
                  <td style={{
                  ...
                  {/* Projeção */}
                  <td style={{ ...td, borderBottom: isLast ? 'none' : td.borderBottom, color: cor, fontWeight: 600 }}>
