      ...
      {hasHeader && (
        ...
        >
          ...
          <div className="flex flex-col gap-0.5 min-w-0">
            {title && (
              <h3 className="font-[var(--f-text)] text-[15px] font-semibold leading-snug text-[var(--fg)] truncate">
                {title}
              </h3>
            )}
            {subtitle && (
              <span className="text-[12px] text-[var(--fg-mute)] leading-snug">{subtitle}</span>
            )}
          </div>
